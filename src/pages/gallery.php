    ...
    <div
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 grid-flow-dense">
          ...
          $sql = "SELECT title, category, entry_date, entry_content, text_color, bg_color FROM diary_entry ORDER BY entry_date DESC LIMIT 4";
    ...
    <div
      ...
      <div class="p-5 flex flex-col gap-5 rounded-lg text-white  " id="music-list-container">
        <div class="grid grid-cols-1 place-content-center place-items-center gap-8 text-center">
          ...
          <p id="musicDescription" class="text-center w-full md:w-5/6 text-sm md:text-[1rem]">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi, culpa. Excepturi obcaecati
            corporis pariatur voluptatibus, asperiores voluptates repudiandae. Dolor, a.
          </p>
        </div>
      </div>
      <div class="flex flex-col bg-black text-white p-3 rounded-md gap-4">
        ...
        <p class="leading-6 text-sm md:text-[1rem]">
          I chose this song for the couple because its lyrics capture the essence of their love story, its
          melody evokes cherished memories, and it symbolizes their journey together beautifully.
        </p>
      </div>
